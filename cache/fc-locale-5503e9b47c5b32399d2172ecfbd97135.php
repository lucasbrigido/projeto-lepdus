<?php return array (
  ...
  'admin.languages.download.cannotOpen' => 'Não foi possível abrir a descição de idioma do site PKP.',
  ...
  'admin.settings.defaultMetricDescription' => 'Sua instalação está configurada para gravar mais de uma métrica de uso. Estatísticas de uso serão mostradas de diferentes modos.
  ...
  'admin.settings.homeHeaderImageInvalid' => 'Formato de imagem inválido. Formatos aceitáveis são .gif, .jpg ou .png. Verifique as configurações de mime_type, permissões e dono de pasta, e tamanho de arquivo permitido.',
