<?php return array (
  ...
  'notification.type.editorAssignmentEditing' => 'Um editor de leiaute deve ser designado antes de iniciar o processo de editoração. Inclua um editor de leiaute usando o link de Participantes acima.',
  ...
  'submission.event.fileRevised' => 'Avaliação "{$name}" (ID do arquivo {$fileId}-{$fileRevision}) foi carregado.',
  ...
  'editor.submission.roundStatus.revisionsRequested' => 'Avaliações foram solicitadas.',
  ...
  'submission.queries.submission' => 'Discussão da pre-avaliação',
  ...
  'submission.submit.submissionLocaleDescription' => 'Arquivos da Submissão',
  ...
  'submission.list.itemOrdererUp' => 'Aumentar posição de {$itemTitle}',
  'submission.list.itemOrdererDown' => 'Diminuir posição de {$itemTitle}',
  'submission.list.reviewsCompleted' => 'Avaliações completadas',
  'submission.list.revisionsSubmitted' => 'Avaliações enviadas',
